...
For a description of Needle's architecture, folder structure, APIs, and module templates, please refer to the general _[Architecture](https://github.com/mwrlabs/needle/wiki/Architecture)_ page on the Wiki.
